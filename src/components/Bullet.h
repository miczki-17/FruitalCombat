...
namespace game::components
{
    ...
    private:
        ...
        // --- Visuals (Shape fallback & Optional Sprite for Textures) ---
        bool useTexture = false;
        sf::CircleShape shape;
        std::optional<sf::Sprite> sprite; // Bezpieczny opcjonalny sprite
        ...
        // Top-Down Ballistic Arc parameters
        bool isParabolic = false;
        sf::Vector2f targetPos;
        sf::Vector2f startPos;
        float totalDistance = 0.0f;
        float arcHeight = 125.0f;
    ...
    public:
        ...
        // Inicjalizacja animacji klatkowej
