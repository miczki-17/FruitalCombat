...
#include "../components/PlayerInputComponent.h" // Poprawiona wielkoϾ liter
...
namespace game::components
{
    ...
    bool ShootAbility::isOnCooldown() const { return cooldownTimer_ > 0.0f; }
    void ShootAbility::resetCooldown() { cooldownTimer_ = cooldown_; }
}